...
class PanopticDeepLabTargetGenerator:
    ...
    def __call__(self, panoptic, segments_info):
        ...
        Returns:
            A dictionary with fields:
                ...
                - center_points: List, center coordinates, with tuple
                    (y-coord, x-coord).
                - panoptic_ids: List, panoptic ids for each instance.
        ...
        center_pts = []
        panoptic_ids = []  # store panoptic ids for each instance
        ...
        return dict(
            ...
            panoptic=torch.as_tensor(panoptic.astype("long")),
