...
class PanopticDeeplabDatasetMapper:
    ...
    def __call__(self, dataset_dict):
        ...
        pan_seg_gt_transformed = transform.apply_segmentation(pan_seg_gt)
        ...
        targets = self.panoptic_target_generator(rgb2id(pan_seg_gt_transformed), dataset_dict["segments_info"])
